...
- [DOMPurify](https://github.com/cure53/DOMPurify "[Cure53] DOM-purify HTML sanitizer. Prevents Cross-Site Scripting (XSS) from malicious inputs or unstable LLM output fragments.") to scrub raw HTML inputs and generated markdown strings prior to rendering.
- Ephemeral payload mapping for AI client connectors ([@google/genai](https://github.com/googleapis/google-genai "[Google] Official Google GenAI SDK. Ephemeral inference payloads, no retention for standard API keys.") and [@google/adk](https://google.github.io/adk-docs/ "[Google] Agent Development Kit. Coordinates agent communication and system instructions.")), ensuring clinical data is processed transiently and not stored on third-party servers.
...
|---|---|---|---|
| [`genkit`](https://firebase.google.com/docs/genkit "[Google] Google's open-source framework for building, running, and debugging GenAI applications.") | Google LLC | Multimodal agent flows and model orchestration | Copyright 2024 Google LLC. [Firebase Genkit](https://firebase.google.com/docs/genkit) |
| [`@google/adk`](https://google.github.io/adk-docs/ "[Google] Google Agent Development Kit. Powers the Live Assist chat routing engine.") | Google LLC | Live consult duplex audio streams | Copyright Google LLC. [ADK Docs](https://google.github.io/adk-docs/) |
| [`@google/genai`](https://github.com/googleapis/google-genai "[Google] Official Google GenAI SDK. Ephemeral inference payloads, no retention for standard API keys.") | Google LLC | Standard client-side/server-side Gemini model calls | Copyright Google LLC. [Google GenAI](https://github.com/googleapis/google-genai) |
| [`@opentelemetry/api`](https://opentelemetry.io/docs/ "[CNCF] Open-source observability framework for cloud-native software. Collects metrics, traces, and logs.") | OpenTelemetry Authors | Diagnostic tracing and performance metrics | Copyright The OpenTelemetry Authors. [OpenTelemetry](https://opentelemetry.io/) |
| [`@aws-sdk/client-healthlake`](https://aws.amazon.com/sdk-for-javascript/ "[Amazon] AWS SDK for JavaScript. Handles interactions with AWS HealthLake and Bedrock.") | Amazon.com, Inc. | Connecting with AWS FHIR health databases | Copyright Amazon.com, Inc. [AWS JS SDK](https://github.com/aws/aws-sdk-js-v3) |
| [`dompurify`](https://github.com/cure53/DOMPurify "[Cure53] Fast, portable HTML sanitizer for HTML5, SVG and MathML. Written by Mario Heiderich.") | Mario Heiderich | HTML sanitization for dynamic rendering safety | Copyright 2015 Mario Heiderich. [Cure53 DOMPurify](https://github.com/cure53/DOMPurify) |
| [`rxjs`](https://rxjs.dev/ "[ReactiveX] Reactive Extensions Library for JavaScript. Uses Observables to coordinate asynchronous streams.") | Google LLC / Contributors | State streaming and pub-sub communications | Copyright Google LLC. [RxJS](https://rxjs.dev/) |

#### Key MIT-Licensed Dependencies
- **Angular Framework** (`@angular/core`, etc.) — Copyright (c) Google LLC. Main UI architecture.
- [**Three.js**](https://threejs.org/ "[Ricardo Cabello] WebGL 3D Library used to render the interactive anatomical pain selection model.") (`three`) — Copyright (c) Ricardo Cabello (mrdoob). Interactive 3D pain models.
...
| Dependency | Author | Purpose | Attribution / Link |
|---|---|---|---|
| [`python-multipart`](https://github.com/andrew-d/python-multipart "[Multipart] Streaming multipart parser for Python FastAPI. Processes form-data uploads.") | Andrew Halberstadt | Multipart form-data parsing for document uploads | Copyright Andrew Halberstadt. [python-multipart](https://github.com/andrew-d/python-multipart) |

#### BSD-3-Clause & MIT-Licensed Dependencies
- [**FastAPI**](https://fastapi.tiangolo.com/ "[Tiangolo] Modern, fast, high-performance web framework for building APIs with Python.") — MIT. Core high-performance sidecar web API.
- [**Pydantic**](https://docs.pydantic.dev/ "[Pydantic] Data validation and settings management using Python type annotations.") — MIT. Strong typing validator.
...
| Dependency | Author | Purpose | Attribution / Link |
|---|---|---|---|
| [`pdf`](https://pub.dev/packages/pdf "[Kaelin] PDF creation and layout library for Dart and Flutter.") | David Kaelin | Clinical summary PDF document generation | Copyright David Kaelin. [pdf on pub.dev](https://pub.dev/packages/pdf) |
| [`printing`](https://pub.dev/packages/printing "[Kaelin] Flutter plugin to print documents or display layout previews.") | David Kaelin | OS-level printing and document preview interface | Copyright David Kaelin. [printing on pub.dev](https://pub.dev/packages/printing) |
| [`mediapipe_genai`](https://pub.dev/packages/mediapipe_genai "[Google] On-device generative AI task coordination library by Google MediaPipe.") | Google LLC | Local on-device Gemini Nano inference | Copyright Google LLC. [MediaPipe GenAI](https://pub.dev/packages/mediapipe_genai) |
| [`hive`](https://pub.dev/packages/hive "[Leier] Lightweight and ultra-fast key-value database written in pure Dart.") | Simon Leier | Lightweight, local NoSQL storage | Copyright Simon Leier. [hive on pub.dev](https://pub.dev/packages/hive) |

#### BSD-3-Clause & MIT-Licensed Dependencies
- [**google_generative_ai**](https://pub.dev/packages/google_generative_ai "[Google] Official Dart SDK for the Gemini API.") — BSD-3-Clause. Official Dart SDK for cloud Gemini.
