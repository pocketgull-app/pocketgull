          ...
          <div class="rounded-xl bg-zinc-50 dark:bg-zinc-950/60 p-4 border border-zinc-200 dark:border-zinc-800 space-y-3">
            <div class="flex flex-wrap items-center justify-between gap-2">
              ...
              <div class="flex items-center gap-1.5 flex-wrap">
                @if (b.oknProvenance) {
                  <span
                    class="px-2 py-0.5 rounded-md bg-blue-500/10 text-blue-700 dark:text-blue-300 font-mono font-bold text-[10px] border border-blue-500/30 flex items-center gap-1"
                    [title]="b.oknProvenance.pathSummary"
                  >
                    <span>🏛️ NSF OKN</span>
                    <span>({{ b.oknProvenance.agencySources.join('+') }})</span>
                  </span>
                }
                <span
