...
export class BodyViewerComponent implements OnDestroy {
  ...
  readonly allParts: Array<{
    ...
    { id: 'acupoint_gv20', name: 'GV-20 Baihui (Hundred Convergences)', secondaryName: '百会 (Crown Confluence - Yang Meeting Point)', paradigm: 'eastern', system: 'tcm', icon: '🌿', symptoms: ['migraine', 'headache', 'dizziness', 'hypertension', 'insomnia', 'depression', 'brain fog', 'prolapse'], clinicalFocus: 'Clears sensory orifices, lifts sunken Yang Qi & pacifies internal wind' },
    ...
    { id: 'acupoint_st36_r', name: 'ST-36 Zusanli (Right Leg Three Miles)', secondaryName: '足三里 (He-Sea Earth Primary Energy Point)', paradigm: 'eastern', system: 'tcm', icon: '🌿', symptoms: ['fatigue', 'chronic exhaustion', 'weak immunity', 'gastritis', 'poor appetite', 'longevity tonic'], clinicalFocus: 'Major systemic tonification point for Post-Natal Qi, blood generation & vitality' },
    { id: 'acupoint_st36_l', name: 'ST-36 Zusanli (Left Leg Three Miles)', secondaryName: '足三里 (He-Sea Earth Primary Energy Point)', paradigm: 'eastern', system: 'tcm', icon: '🌿', symptoms: ['fatigue', 'low vitality', 'indigestion', 'immune deficiency', 'leg weakness'], clinicalFocus: 'Replenishes vital Qi, balances digestive motility & supports recovery' },
    { id: 'acupoint_li4_r', name: 'LI-4 Hegu (Right Joining Valley)', secondaryName: '合谷 (Yuan-Source Primary Head/Face Point)', paradigm: 'eastern', system: 'tcm', icon: '🌿', symptoms: ['headache', 'toothache', 'sinus congestion', 'facial pain', 'constipation', 'stress tension'], clinicalFocus: 'Primary point for sensory organs of head & face; releases exterior wind' },
    { id: 'acupoint_li4_l', name: 'LI-4 Hegu (Left Joining Valley)', secondaryName: '合谷 (Yuan-Source Primary Head/Face Point)', paradigm: 'eastern', system: 'tcm', icon: '🌿', symptoms: ['headache', 'migraine', 'jaw tension', 'tmj', 'nasal allergy', 'constipation'], clinicalFocus: 'Potent analgesic and Qi regulator; pairs with LR-3 (Four Gates)' },
    ...
    { id: 'acupoint_pc6_r', name: 'PC-6 Neiguan (Right Inner Pass)', secondaryName: '内关 (Luo-Connecting Primary Cardiac Point)', paradigm: 'eastern', system: 'tcm', icon: '🌿', symptoms: ['nausea', 'motion sickness', 'morning sickness', 'palpitations', 'anxiety', 'chest oppression', 'insomnia'], clinicalFocus: 'Opens the chest, regulates Heart rate variability & subdues rebellious Stomach Qi' },
    { id: 'acupoint_pc6_l', name: 'PC-6 Neiguan (Left Inner Pass)', secondaryName: '内关 (Luo-Connecting Primary Cardiac Point)', paradigm: 'eastern', system: 'tcm', icon: '🌿', symptoms: ['nausea', 'vomiting', 'cardiac arrhythmia', 'panic', 'emotional stress'], clinicalFocus: 'Vagal neuromodulation corridor & Shen stabilizer' },
    ...
    { id: 'acupoint_bl40_r', name: 'BL-40 Weizhong (Right Bend Middle)', secondaryName: '委中 (Popliteal Fossa Lumbar Command Point)', paradigm: 'eastern', system: 'tcm', icon: '🌿', symptoms: ['acute back spasm', 'sciatica', 'knee pain', 'hamstring strain', 'lumbar stiffness'], clinicalFocus: 'Primary command point for the back; clears heat from blood & releases lumbar tension' },

    // 🪷 3. Ayurvedic Marmas & Chakras
    { id: 'marma_adhipati', name: 'Adhipati Marma (Crown Supreme)', secondaryName: 'अधिपति (Sahasrara Crown Chakra Center)', paradigm: 'ayurvedic', system: 'ayurveda', icon: '🪷', symptoms: ['headache', 'mental stress', 'spiritual disconnect', 'insomnia', 'ojas depletion', 'neurological strain'], clinicalFocus: 'Supreme junction point controlling Prana Vayu, consciousness & higher cognitive ojas' },
