...
export class DoctorShiftSimulatorComponent implements OnDestroy {
  ...
  patientCases: Record<number, IShiftPatientCase[]> = {
    ...
    1: [
      { id: 'sc05', time: '09:15 AM', patientName: 'Homo Sapiens (Male, 44y)', ward: 'Outpatient Clinic', chiefComplaint: 'L5-S1 radiculopathy, fatigue, circadian disruption', triageLevel: 'L3-YELLOW', triageColor: 'bg-amber-950 text-amber-300 border border-amber-500/50', parityAudit: 'Pass (Optimal)' },
