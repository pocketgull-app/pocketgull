...
| **bionic reading** | `src/services/bionic-reading.service.ts` | - | ❌ Missing in Flutter |
...
| **impact master program agreement** | `src/services/impact-master-program-agreement.service.ts` | - | ❌ Missing in Flutter |
...
| **master paradigm synthesizer** | `src/components/suites/master-paradigm-synthesizer.component.ts` | - | ❌ Missing in Flutter |
...
## Summary
- **Matched Features**: 84
- **Missing in Flutter (Needs Migration)**: 517
- **Flutter Only (New Architecture/Components)**: 49
