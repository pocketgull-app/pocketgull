## Description
<!-- Describe your changes in detail. Explain WHY you made the change. -->

## Changelog Entry
<!-- 
Please write a changelog-ready description using this format:
- **[Component / Subsystem] Feature Name (`relevant-file.ts`)**:
...
- [ ] My commit messages follow the Conventional Commits format (max 72 chars subject, imperative mood).
- [ ] My branch compiles with zero errors (`node node_modules/typescript/lib/tsc.js -p tsconfig.json --noEmit`).
- [ ] I have performed a self-review of my own code.
- [ ] New and existing unit tests pass locally with my changes (`npm test`).
- [ ] I have run the local security audit (`npm run sentinel:audit`).
