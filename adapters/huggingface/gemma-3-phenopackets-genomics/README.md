...
# 🕊️ PocketGull Gemma 3 GA4GH Phenopackets v2 Translator
...
## 📌 Overview
Translates free-text clinical notes into compliant GA4GH Phenopackets Schema v2.0 JSON with HPO/LOINC concepts.
...
adapter_id = "pocketgull-llc/gemma-3-phenopackets-genomics"
