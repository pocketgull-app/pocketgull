...
// 1. High-Impact Brand & Character Map Specimen (1200x630 Social/Investor Image)
const specimen1Svg = `
<svg width="1200" height="630" viewBox="0 0 1200 630" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <radialGradient id="sunlightBg" cx="50%" cy="30%" r="75%">
      <stop offset="0%" stop-color="#fba668"/>
      <stop offset="100%" stop-color="#f48242"/>
    </radialGradient>
  </defs>
  <!-- Background -->
  <rect width="100%" height="100%" fill="url(#sunlightBg)"/>
  
  <!-- Outer Card Frame -->
  <rect x="40" y="40" width="1120" height="550" rx="30" fill="rgba(255, 248, 240, 0.95)" stroke="#e07a3c" stroke-width="6"/>
  
  <!-- Title Badge -->
  <rect x="80" y="75" width="460" height="42" rx="21" fill="#ea580c"/>
  <text x="100" y="103" font-family="'Inter', sans-serif" font-weight="900" font-size="16" fill="#ffffff" letter-spacing="3">
    POCKETGULL TYPEFACE SPECIMEN
  </text>
  
  <!-- Main Logo Wordmark SVG Path Representation -->
  <g transform="translate(80, 150) scale(3.2)">
  ...
  <!-- Subtitle -->
  <text x="80" y="440" font-family="'Inter', sans-serif" font-weight="700" font-size="28" fill="#ea580c">
    Handcrafted Felt-Tip Marker Typography &amp; Clinical Legibility Engine
  </text>

  <!-- Multilingual & Numerals Row -->
  <text x="80" y="500" font-family="'Inter', sans-serif" font-weight="600" font-size="24" fill="#334155">
    Aa Bb Cc Dd Ee 0123456789 ٠١٢ I V X ½ ± % ñ é ü æ ç å α β Ω Б
  </text>
  
  <!-- Footer -->
  <text x="80" y="550" font-family="'Inter', sans-serif" font-weight="500" font-size="16" fill="#64748b">
    SIL Open Font License 1.1 • Certified WCAG 2.1 AAA Contrast Ratio (≥ 7.0:1)
  </text>
</svg>
`;

// Render Specimen Banner Image using Sharp
const imgPath = path.join(outputDir, 'pocketgull_master_typespecimen.png');
sharp(Buffer.from(specimen1Svg))
  .png()
  .toFile(imgPath)
  .then(() => {
    console.log(`✅ Generated Master Typeface Specimen PNG: ${imgPath}`);
  })
  .catch(err => {
    console.error('Error generating specimen image via Sharp:', err);
  });
