...
| :--- | :---: | :--- |
| **1. Cost-to-Replicate Asset Floor** <br>*(Current 2026)* | **$15.9M – $24.9M** | **Proprietary Tech Stack & Architecture (COCOMO II / COSYSMO / COCOTS / SLIM):** <br>• 338K+ SLOC across 993+ files (Angular 22, Flutter/Dart, Python FastAPI)<br>• 673 person-months estimated traditional effort (56.1 solo-developer-years)<br>• Dual-engine containerized backend (Node.js/Express + FastAPI Python sidecar)<br>• **200 Staked Patent Claims across 10 Invention Clusters**<br>• OpenSSF Scorecard 10/10, zero SBOM NOASSERTION, zero swallowed errors. |
