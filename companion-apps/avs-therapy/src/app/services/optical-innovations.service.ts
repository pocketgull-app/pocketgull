...
/**
 * OpticalInnovationsService — Clinical Ophthalmic & Photobiomodulation Engine
 *
 * Implements:
...
export class OpticalInnovationsService {
  ...
  readonly ganzfeldState = signal<IGanzfeldOrpState>({
    fieldColorHex: '#E0E7FF', // Indigo-50 ambient wash
    reticleDiameterPx: 4,
  ...
  // ── 1. 670nm Photobiomodulation Session Controls ─────────────────────────
  ...
  // ── 3. CIE S 026 Melanopic ipRGC Circadian Controls ──────────────────────
    ...
    switch (phase) {
      ...
      case 'night-ruby':
        this.melanopicState.set({
          ...
          melanopicEdiLux: 0.6,
          blueAttenuationPercent: 100, // 100% blue stripped (<1 lux EML)
